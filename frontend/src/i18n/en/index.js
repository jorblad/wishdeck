export default {
  ...
  quickAdd: {
    ...
    priority: 'Priority',
    quantity: 'Quantity',
    quantityHint: 'Clear to hide quantity',
    add: 'Add item',
    added: 'Item added',
  ...
  bulkImport: {
    ...
    textLabel: 'Paste one item per line. URLs are extracted automatically.',
    category: 'Category for all imported items',
    import: 'Import',
    imported: 'Imported {count} items',
    failed: 'Could not import items',
    htmlHint: 'Or paste OneNote / web-page HTML here to extract real links:',
    htmlPlaceholder: 'Paste HTML (Ctrl+V) from an exported OneNote page or browser source...',
    extracted: 'Extracted {count} links',
    noLinksFound: 'No http(s) links found in the pasted HTML.',
    extractFailed: 'Could not extract links',
    scrape: 'Scrape each link for title, price and image',
  },
  menu: {
    settings: 'Settings',
  ...
  collaborators: {
    title: 'Collaborators',
    add: 'Add a person by name or email',
    share: 'Share',
    added: 'Collaborator added',
    none: 'No one has been shared with yet.',
    noUsers: 'No users found',
    canEdit: 'Can edit',
    viewOnly: 'View only',
    remove: 'Remove access',
    youCanEdit: 'Shared with you — you can edit this list.',
    youViewOnly: 'Shared with you — view only.',
    shared: 'Shared',
